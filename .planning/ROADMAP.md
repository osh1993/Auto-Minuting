...
- [ ] **Phase 10: NotebookLM 반자동 연동** - 공유 Intent + Custom Tabs + MCP 검토 (2일 타임박스)
- [ ] **Phase 11: 삼성 자동 감지 스파이크** - ContentObserver/FileObserver 실기기 검증 (48시간 타임박스)
