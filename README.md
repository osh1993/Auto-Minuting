...
| 버전 | 날짜 | 주요 변경 | 다운로드 |
|------|------|-----------|----------|
| **v9.0** | 2026-04-15 | 다중 Gemini API 키 라운드로빈, 홈 화면 파일 직접 입력, Groq 대용량 자동 청크 분할, MP3 합치기 | [AutoMinuting-v9.0-release.apk](https://github.com/osh1993/Auto-Minuting/releases/download/v9.0/AutoMinuting-v9.0-release.apk) |
...
| 버전 | 주요 기능 |
|------|-----------|
| v9.0 | 다중 Gemini API 키 라운드로빈, 홈 화면 파일 직접 입력, Groq 대용량 자동 청크 분할, MP3 합치기 |
