...
v8.0 — 5분 안에 첫 회의록 만들기

---

## Step 1 — 앱 설치

1. [GitHub Releases](https://github.com/osh1993/Auto-Minuting/releases)에서 `AutoMinuting-v8.0-release.apk` 다운로드
...
### 음성 파일 (여러 개 동시 — v8.0 신기능)

- 삼성 녹음앱에서 **여러 파일 다중 선택** → 공유 → **Auto Minuting**
- 자동으로 하나의 파일로 합쳐진 후 전사 시작 (첫 번째 파일명 사용)
...
| 여러 녹음 파일 한 번에 | 삼성 녹음앱에서 다중 선택 공유 (v8.0) |
| Groq 파일 크기 초과 | 설정 → STT 엔진을 Gemini 또는 Whisper로 변경 |
